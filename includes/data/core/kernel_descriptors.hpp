...
#ifndef BATMANINFER_KERNEL_DESCRIPTORS_HPP
#define BATMANINFER_KERNEL_DESCRIPTORS_HPP
...
/** Descriptor used by the GEMM kernels */
    struct GEMMKernelInfo {
        ...
        GEMMKernelInfo(unsigned int im,
                       ...
                       bool ihas_pad_y,
                       BIActivationLayerInfo iactivation_info,
        ...
        bool fp_mixed_precision{
                false}; /**< Flag used to indicate wider accumulators (32 bit instead of 16 for FP16). */
        bool has_pad_y{
                false}; /**< Flag used to indicate if the input/output tensors have internal pad on the y direction */
        BIActivationLayerInfo activation_info{}; /**< Activation function to perform after the matrix multiplication */
        ...
        BIGEMMLowpOutputStageInfo output_stage{}; /**< GEMMLowp output stage information */
    };
...
/** Descriptor used by the softmax kernels */
    struct SoftmaxKernelInfo {
        ...
        BIDataType input_data_type{BIDataType::UNKNOWN}; /**< Input tensor data type */
...
/** Descriptor used by the direct convolution layer output stage kernels */
    ...
    struct ScaleKernelInfo {
         ...
         */
        ScaleKernelInfo(BIInterpolationPolicy interpolation_policy,
                        BorderMode border_mode,
                        BIPixelValue constant_border_value = BIPixelValue(),
                        SamplingPolicy sampling_policy = SamplingPolicy::CENTER,
                        bool use_padding = true,
                        bool align_corners = false,
                        BIDataLayout data_layout = BIDataLayout::UNKNOWN) noexcept
        ...
        BIInterpolationPolicy interpolation_policy;  /**< Interpolation type to use */
        BorderMode border_mode;           /**< Border mode policy */
        BIPixelValue constant_border_value; /**< Constant value to use for constant border mode policy */
        ...
        BIDataLayout data_layout;           /**< Data layout to use */
    };
    ...
    struct MatMulKernelInfo {
        ...
        MatMulKernelInfo(
                ...
                : adj_lhs{adj_lhs}, adj_rhs{adj_rhs}, m0{m0}, n0{n0}, k0{k0},
                  export_rhs_to_cl_image{export_rhs_to_cl_image} {
        }
...
#endif //BATMANINFER_KERNEL_DESCRIPTORS_HPP
