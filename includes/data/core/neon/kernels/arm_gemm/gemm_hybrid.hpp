...
namespace BatmanGemm {
    ...
    class GemmHybrid : public BIGemmCommon<To, To, Tr> {
    ...
    public:
        ...
        void execute_stateless(const ndcoord_t &work_range, const ndcoord_t &, int,
            ...
            for (unsigned int k0 = 0; k0 < _Ksize; k0 += _k_block) {
                ...
                do {
                    ...
                    strat.kernel(g_array._Aptr + (multi * g_array._A_multi_stride) + (batch * g_array._A_batch_stride) +
        ...
        size_t get_B_pretransposed_array_size() const override {
            return roundup(_Nsize, strategy::out_width()) * roundup(_Ksize, strategy::k_unroll()) * _nmulti *
                   sizeof(Toi);
        }

        void pretranspose_B_array(void *in_buffer, const To *B, const int ldb, const int B_multi_stride,
        ...
        static uint64_t estimate_cycles(const GemmArgs &args, const PerformanceParameters &params) {
            ...
            uint64_t total_macs = static_cast<uint64_t>(args._nbatches) * args._nmulti * args._Msize *
                                  roundup(args._Nsize, strategy::out_width()) *
                                  roundup(args._Ksize, strategy::k_unroll());
            ...
            // most noticeable where the overall width is quite low, so add 15%
