...
#ifndef BATMANINFER_WRAPPER_CVT_HPP
#define BATMANINFER_WRAPPER_CVT_HPP
...
#undef VCVT_TO_F16_IMPL
        ...
        inline typename std::enable_if<
                std::is_same<T, uint8_t>::value || std::is_same<T, uint32_t>::value, uint32x4_t>::type
        ...
        template<typename T>
        inline typename std::enable_if<
                std::is_same<T, int8_t>::value || std::is_same<T, int32_t>::value, int32x4_t>::type
        vcvt(const float32x4_t &a) {
...
#endif //BATMANINFER_WRAPPER_CVT_HPP
