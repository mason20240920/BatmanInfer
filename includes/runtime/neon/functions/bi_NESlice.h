...
namespace BatmanInfer {
    ...
    public:
         ...
         */
        void configure(const BIITensor *input, BIITensor *output, const BICoordinates &starts, const BICoordinates &ends);
         ...
         */
        static BIStatus
        validate(const BIITensorInfo *input, const BIITensorInfo *output, const BICoordinates &starts, const BICoordinates &ends);
