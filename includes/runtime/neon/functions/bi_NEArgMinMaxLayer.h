...
namespace BatmanInfer {
    ...
    public:
        /** Constructor */
        BINEArgMinMaxLayer(std::shared_ptr<BIIMemoryManager> memory_manager);
        BINEArgMinMaxLayer() : BINEArgMinMaxLayer(BIMemoryManagerOnDemand::make_default())
        {
        }
         ...
         * @return a status
         */
        static BIStatus validate(const BIITensorInfo *input, int axis, const BIITensorInfo *output, const BIReductionOperation &op);
