...
#ifndef BATMANINFER_BI_TENSORDESCRIPTOR_H
#define BATMANINFER_BI_TENSORDESCRIPTOR_H
...
namespace graph {
    ...
    struct BITensorDescriptor final : public misc::BIICloneable<BITensorDescriptor>
    {
        /** Default Constructor **/
...
#endif //BATMANINFER_BI_TENSORDESCRIPTOR_H
