 ...
 */
    ...
    inline void nchw_to_nhwc(const uint8_t *const in,
                             ...
                             int out_row_stride,
                             int out_col_stride) {
        nchw_to_nhwc(reinterpret_cast<const int8_t *>(in), reinterpret_cast<int8_t *>(out), n_batches, n_channels,
                     n_rows,
