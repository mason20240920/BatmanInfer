...
namespace BatmanInfer {
    namespace cpu {
        ...
        typename VectorType::type elementwise_arithm_op(const typename VectorType::type &a,
        ...
        typename VectorType::type elementwise_arithm_op_broadcast(const typename VectorType::type &a,
            ...
            return elementwise_arithm_op<op, VectorType>(reorder ? broadcast_vector : a,
        ...
        void elementwise_op(
            ...
            BIWindow input1_win = window.broadcast_if_dimension_le_one(in1->info()->tensor_shape());
            BIWindow input2_win = window.broadcast_if_dimension_le_one(in2->info()->tensor_shape());
            ...
            if (is_broadcast_across_x) {
                ...
                const BIITensor *broadcast_tensor = is_broadcast_input_2 ? in2 : in1;
                const BIITensor *non_broadcast_tensor = !is_broadcast_input_2 ? in2 : in1;
                ...
                BIIterator input1(in1, input1_win);
                BIIterator input2(in2, input2_win);
                BIIterator output(out, win);
        ...
        template<>
        inline float16x8_t
        elementwise_arithm_op<ArithmeticOperation::DIV, typename wrapper::traits::neon_vector<float16_t, 8>>(
        ...
        inline int elementwise_arithm_op_broadcast_loop(int window_start_x,
            ...
            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                ...
                wrapper::vstore(output_ptr + x,
                                elementwise_arithm_op_broadcast<op, ScalarType, VectorType>(a, broadcast_value,
                                                                                            reorder));
            }
            return x;
        }
        ...
        template<ArithmeticOperation op, typename VectorType>
        void elementwise_arithm_op(const BIITensor *in1, const BIITensor *in2, BIITensor *out, const BIWindow &window) {
            using scalar_type = typename VectorType::scalar_type;
        ...
        elementwise_comp_op_broadcast(const InputVectorType &a, const InputScalarType &broadcast_value,
                                      const bool reorder) {
        ...
        inline int elementwise_comp_op_broadcast_32_loop(int window_start_x,
            ...
            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                ...
                wrapper::vstore(output_ptr + x,
                                wrapper::vmovn(wrapper::vcombine(wrapper::vmovn(a), wrapper::vmovn(b))));
            }
            if (x <= window_end_x - 4) {
                const auto a = elementwise_comp_op_broadcast<op, InputScalarType, InputVectorType, uint32x4_t>(
                        wrapper::vloadq((non_broadcast_input_ptr + x)), broadcast_value, reorder);
        ...
        inline int elementwise_comp_op_32_loop(int window_start_x,
            ...
            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                ...
                wrapper::vstore(output_ptr + x,
                                wrapper::vmovn(wrapper::vcombine(wrapper::vmovn(res), wrapper::vmovn(res2))));
            }
            if (x <= window_end_x - 4) {
                const auto a = wrapper::vloadq(input1_ptr + x);
                const auto b = wrapper::vloadq(input2_ptr + x);
        ...
        template<ComparisonOperation op, typename InputScalarType, typename InputVectorType>
        void elementwise_comp_op_8(const BIITensor *in1, const BIITensor *in2, BIITensor *out, const BIWindow &window) {
        ...
        template<ComparisonOperation op, typename InputScalarType, typename InputVectorType>
        void
        elementwise_comp_op_16(const BIITensor *in1, const BIITensor *in2, BIITensor *out, const BIWindow &window) {
            elementwise_op<InputScalarType, uint8_t, InputVectorType>(
                    in1, in2, out, window, &elementwise_comp_op_scalar<op, InputScalarType>,
        ...
        template<ComparisonOperation op, typename InputScalarType, typename InputVectorType>
        void
        elementwise_comp_op_32(const BIITensor *in1, const BIITensor *in2, BIITensor *out, const BIWindow &window) {
            elementwise_op<InputScalarType, uint8_t, InputVectorType>(
                    in1, in2, out, window, &elementwise_comp_op_scalar<op, InputScalarType>,
        ...
        load_quantized(const uint8_t *input1_ptr, const int32x4_t &offset, const float32x4_t &scale) {
            qasymm8x16_t x = vld1q_u8(input1_ptr);
            const float32x4x4_t out = {{
                                               vmulq_f32(
                                                       vcvtq_f32_s32(vsubq_s32(vreinterpretq_s32_u32(
                                                                                       vmovl_u16(vget_low_u16(vmovl_u8(vget_low_u8(x))))),
                                                                               offset)),
                                                       scale),
                                               vmulq_f32(
                                                       vcvtq_f32_s32(vsubq_s32(vreinterpretq_s32_u32(
                                                                                       vmovl_u16(vget_high_u16(vmovl_u8(vget_low_u8(x))))),
                                                                               offset)),
                                                       scale),
                                               vmulq_f32(
                                                       vcvtq_f32_s32(vsubq_s32(vreinterpretq_s32_u32(
                                                                                       vmovl_u16(vget_low_u16(vmovl_u8(vget_high_u8(x))))),
                                                                               offset)),
                                                       scale),
                                               vmulq_f32(vcvtq_f32_s32(
                                                                 vsubq_s32(vreinterpretq_s32_u32(
                                                                                   vmovl_u16(vget_high_u16(vmovl_u8(vget_high_u8(x))))),
                                                                           offset)),
                                                         scale),
                                       }};
            return out;
        ...
        inline float32x4x4_t
        load_quantized(const int8_t *input1_ptr, const int32x4_t &offset, const float32x4_t &scale) {
            qasymm8x16_signed_t x = vld1q_s8(input1_ptr);
            const float32x4x4_t out = {{
                                               vmulq_f32(vcvtq_f32_s32(
                                                       vsubq_s32(vmovl_s16(vget_low_s16(vmovl_s8(vget_low_s8(x)))),
                                                                 offset)), scale),
                                               vmulq_f32(vcvtq_f32_s32(
                                                       vsubq_s32(vmovl_s16(vget_high_s16(vmovl_s8(vget_low_s8(x)))),
                                                                 offset)), scale),
                                               vmulq_f32(vcvtq_f32_s32(
                                                       vsubq_s32(vmovl_s16(vget_low_s16(vmovl_s8(vget_high_s8(x)))),
                                                                 offset)), scale),
                                               vmulq_f32(vcvtq_f32_s32(
                                                       vsubq_s32(vmovl_s16(vget_high_s16(vmovl_s8(vget_high_s8(x)))),
                                                                 offset)), scale),
                                       }};
            return out;
        }
        ...
        inline void
        store_quantized(uint8_t *output_ptr, const float32x4x4_t &rf, const float32x4_t &offset,
                        const float32x4x4_t &invscale) {
        ...
        inline void
        store_quantized(int8_t *output_ptr, const float32x4x4_t &rf, const float32x4_t &offset,
                        const float32x4x4_t &invscale) {
        ...
        vcltq_f32(rf.val[3], vdupq_n_f32(0.0f)),
            ...
            const float32x4x4_t adj_offset = {{
                                                      vaddq_f32(offset,
                                                                vbslq_f32(cmp.val[0], neg_point_5, pos_point_5)),
                                                      vaddq_f32(offset,
                                                                vbslq_f32(cmp.val[1], neg_point_5, pos_point_5)),
                                                      vaddq_f32(offset,
                                                                vbslq_f32(cmp.val[2], neg_point_5, pos_point_5)),
                                                      vaddq_f32(offset,
                                                                vbslq_f32(cmp.val[3], neg_point_5, pos_point_5)),
                                              }};
        ...
        union ElementwiseQuantizedScalarParams {
            ...
            struct Generic {
                float a;
                float b;
                BIUniformQuantizationInfo qinfo; // Unused in comparison operations
            } generic;
        ...
        template<ArithmeticOperation op,
                ...
                typename = std::enable_if_t<
                        (std::is_same<Input, int8_t>::value || std::is_same<Input, uint8_t>::value) &&
        ...
        inline Output elementwise_arithm_op_quantized_scalar(const ElementwiseQuantizedScalarParams<Input> &params) {
            ...
            return BIQasymm8QuantizationHelper<Output>::quantize(res, _.qinfo);
        }
...
// where quant_s1 and quant_s2 use the normal output offset, but scales s1 = scale_out / scale_a and s2 = s1 / scale_b respectively.
        ...
        inline Output elementwise_prelu_quantized_scalar(
            ...
            if (a_minus_offset > 0) {
                return BIQasymm8QuantizationHelper<Output>::quantize(static_cast<float>(a_minus_offset),
                                                                     BIUniformQuantizationInfo{s1, o_offset});
            } else {
                int b_minus_offset = static_cast<int>(b) - b_offset;
                return BIQasymm8QuantizationHelper<Output>::quantize(
                        static_cast<float>(a_minus_offset) * b_minus_offset,
                        BIUniformQuantizationInfo{s2, o_offset});
            }
        }
        ...
        inline int8_t elementwise_arithm_op_quantized_scalar<ArithmeticOperation::PRELU, int8_t, int8_t>(
            ...
            const auto &_ = params.prelu;
            return elementwise_prelu_quantized_scalar<int8_t, int8_t>(_.a, _.b, _.s1, _.s2, _.a_offset, _.b_offset,
                                                                      _.o_offset);
        }
...
// where quant_s1 and quant_s2 use the normal output offset, but scales s1 = scale_out / scale_a and s2 = s1 / scale_b respectively.
        ...
        inline int elementwise_prelu_quantized_loop(int window_start_x,
                                                    ...
                                                    float32x4_t voffseto,
                                                    float32x4_t invvscaleo) {
            BI_COMPUTE_UNUSED(invvscaleo);

            int x = window_start_x;
            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                const int32x4x4_t a_minus_offset = widen_to_i32_and_offset(wrapper::vloadq(input1_ptr + x),
                                                                           v_neg_offset1);
                const int32x4x4_t b_minus_offset = widen_to_i32_and_offset(wrapper::vloadq(input2_ptr + x),
                                                                           v_neg_offset2);
...
// Note: v_neg_offset1 and v_neg_offset2 are negated compared to the generic template.
        template<>
        inline int
        elementwise_arithm_op_quantized_loop<ArithmeticOperation::PRELU, uint8_t, uint8_t>(int window_start_x,
                                                                                           int window_end_x,
                                                                                           int window_step_x,
            ...
            return elementwise_prelu_quantized_loop(window_start_x, window_end_x, window_step_x, input1_ptr, input2_ptr,
                                                    output_ptr, v_neg_offset1, v_neg_offset2, vinv_s1, vinv_s2,
                                                    voffseto,
                                                    invvscaleo);
        }
...
// Implements one vector worth of PReLU on quantized data where the first operand is broadcast.
        ...
        inline void elementwise_prelu_quantized_broadcast_vector(int32_t a_minus_offset,
            ...
            if (a_minus_offset > 0) {
                const Output res = BIQasymm8QuantizationHelper<Output>::quantize(static_cast<float>(a_minus_offset),
                                                                                 BIUniformQuantizationInfo{s1,
                                                                                                           o_offset});
            ...
            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                if (reorder) {
                    ...
                    elementwise_prelu_quantized_broadcast_vector(broadcast_minus_offset, non_broadcast_input_ptr + x,
                                                                 vnegoffset_non_broadcast, output_ptr + x, _.s1,
                                                                 _.vinv_s2,
                                                                 voffseto, _.o_offset);
                } else {
                    ...
                    elementwise_prelu_quantized_broadcast_vector(non_broadcast_input_ptr + x, vnegoffset_non_broadcast,
                                                                 broadcast_minus_offset, output_ptr + x, _.vinv_s1,
                                                                 _.vinv_s2,
                                                                 voffseto);
                }
            }
...
// Note: vnegoffset_non_broadcast is negated compared to the generic template.
        ...
        inline int elementwise_arithm_op_quantized_broadcast_loop<ArithmeticOperation::PRELU, uint8_t, uint8_t>(
            ...
            return elementwise_prelu_quantized_broadcast_loop(window_start_x, window_end_x, window_step_x,
                                                              non_broadcast_input_ptr, output_ptr,
                                                              vnegoffset_non_broadcast,
...
// Note: vnegoffset_non_broadcast is negated compared to the generic template.
        ...
        inline int elementwise_comp_op_quantized_loop(int window_start_x,
                                                      ...
                                                      float32x4_t voffseto,
                                                      float32x4_t invvscaleo) {
            BI_COMPUTE_UNUSED(voffseto, invvscaleo);
            int x = window_start_x;
            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                const float32x4x4_t af = load_quantized(input1_ptr + x, voffset1, vscale1);
                const float32x4x4_t bf = load_quantized(input2_ptr + x, voffset2, vscale2);
        ...
        template<typename Input,
                ...
                typename = std::enable_if_t<
                        (std::is_same<Input, int8_t>::value || std::is_same<Input, uint8_t>::value) &&
                        (std::is_same<Output, int8_t>::value || std::is_same<Output, uint8_t>::value)>>
        inline void elementwise_op_quantized(const BIITensor *in1,
                                             const BIITensor *in2,
                                             BIITensor *out,
                                             const BIWindow &window,
                                             ...
                                             int (*neon_func)(int,
                                                              ...
                                                              float32x4_t)) {
            bool is_prelu =
                    scalar_func == &elementwise_arithm_op_quantized_scalar<ArithmeticOperation::PRELU, Input, Output>;
            if (is_prelu) {
                BI_COMPUTE_ERROR_ON(
                        broadcast_func !=
                        (&elementwise_arithm_op_quantized_broadcast_loop<ArithmeticOperation::PRELU, Input, Output>));
                BI_COMPUTE_ERROR_ON(neon_func !=
            ...
            const BIUniformQuantizationInfo output_qinfo = out->info()->quantization_info().uniform();
            const BIUniformQuantizationInfo input1_qinfo = in1->info()->quantization_info().uniform();
            const BIUniformQuantizationInfo input2_qinfo = in2->info()->quantization_info().uniform();
            ...
            const float32x4_t prelu_vinv_s1 = is_prelu ? vdupq_n_f32(input1_qinfo.scale / output_qinfo.scale)
                                                       : float32x4_t{};
            const float32x4_t prelu_vinv_s2 =
                    is_prelu ? vdupq_n_f32(input1_qinfo.scale * input2_qinfo.scale / output_qinfo.scale)
                             : float32x4_t{};
            ...
            if (is_broadcast_across_x) {
                ...
                const float32x4_t vscale_non_broadcast = !is_prelu ? vdupq_n_f32(non_broadcast_qinfo.scale)
                                                                   : float32x4_t{};
                ...
                execute_window_loop(
                        ...
                        [&](const BICoordinates &) {
                            ...
                            const float broadcast_value_deq =
                                    is_prelu ? 0.0f : BIQasymm8QuantizationHelper<Input>::dequantize(broadcast_value,
                                                                                                     broadcast_qinfo);
                            ...
                            int x = (*broadcast_func)(window_start_x, window_end_x, window_step_x,
                                                      non_broadcast_input_ptr,
                                                      output_ptr, voffset_non_broadcast, voffseto,
                                                      !is_broadcast_input_2, params);
                            for (; x < window_end_x; ++x) {
                                ...
                                if (is_prelu) {
                                    ...
                                    const float non_broadcast_value_deq =
                                            BIQasymm8QuantizationHelper<Input>::dequantize(non_broadcast_value,
                                                                                           non_broadcast_qinfo);
                                    params.generic = {
                        ...
                        [&](const BICoordinates &) {
                            ...
                            for (; x < window_end_x; ++x) {
                                ...
                                if (is_prelu) {
                                    ...
                                    params.generic = {
                                            BIQasymm8QuantizationHelper<Input>::dequantize(input1_value, input1_qinfo),
                                            BIQasymm8QuantizationHelper<Input>::dequantize(input2_value, input2_qinfo),
                                            output_qinfo,
                                    };
                                }
        ...
        template<ArithmeticOperation op>
        void
        elementwise_arithm_op_quantized(const BIITensor *in1, const BIITensor *in2, BIITensor *out,
                                        const BIWindow &window) {
        ...
        template<ArithmeticOperation op>
        void elementwise_arithm_op_quantized_signed(const BIITensor *in1, const BIITensor *in2, BIITensor *out,
                                                    const BIWindow &window) {
        ...
        template<ComparisonOperation op>
        void elementwise_comp_op_quantized(const BIITensor *in1, const BIITensor *in2, BIITensor *out,
                                           const BIWindow &window) {
        ...
        template<ComparisonOperation op>
        void elementwise_comp_op_quantized_signed(const BIITensor *in1, const BIITensor *in2, BIITensor *out,
                                                  const BIWindow &window) {
            elementwise_op_quantized<int8_t, uint8_t>(in1, in2, out, window,
                                                      &elementwise_comp_op_quantized_scalar<op, int8_t>,
