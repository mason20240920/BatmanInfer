...
namespace BatmanInfer {
    namespace cpu {
        bool sub_q8_neon_fixedpoint_possible(const BIITensorInfo *src0,
                                             const BIITensorInfo *src1,
                                             const BIITensorInfo *dst) {
            return add_sub_q8_neon_fixedpoint_possible(src0, src1, dst, false);
        }

        bool add_q8_neon_fixedpoint_possible(const BIITensorInfo *src0,
                                             const BIITensorInfo *src1,
                                             const BIITensorInfo *dst) {
        ...
        void add_sub_q8_neon_fixedpoint(const BIITensor *src0,
            ...
            const auto offset =
                    float(oq_info.offset) - in0_scale * float(iq0_info.offset) - in1_scale * float(iq1_info.offset);
            ...
            if (is_broadcast_across_x) {
                ...
                execute_window_loop(
                        ...
                        [&](const BICoordinates &) {
                            ...
                            const auto b_scaled_21p11 = static_cast<int32_t>(support::cpp11::lround(
                                    b_scaled * _2pow11));
                            ...
                            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                                ...
                                const auto vout_21p11_00 =
                                        wrapper::vmlal(b_vscaled_offseted_21p11, wrapper::vgetlow(a_vin_16p0_0),
                                                       a_vscale_5p11);
                                const auto vout_21p11_01 =
                                        wrapper::vmlal(b_vscaled_offseted_21p11, wrapper::vgethigh(a_vin_16p0_0),
                                                       a_vscale_5p11);
                                const auto vout_21p11_10 =
                                        wrapper::vmlal(b_vscaled_offseted_21p11, wrapper::vgetlow(a_vin_16p0_1),
                                                       a_vscale_5p11);
                                const auto vout_21p11_11 =
                                        wrapper::vmlal(b_vscaled_offseted_21p11, wrapper::vgethigh(a_vin_16p0_1),
                                                       a_vscale_5p11);
                                ...
                                const auto vout_8p0 =
                                        wrapper::vcombine(wrapper::vqrshrn<8>(vout_8p8_0),
...
#ifdef __aarch64__
                                out_ptr[x] = wrapper::vqrshrn<8>(
                                        wrapper::vqrshrn_ex<shift_amount_remainder, ScalarType>(
                ...
                execute_window_loop(
                        ...
                        [&](const BICoordinates &) {
                            ...
                            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                                ...
                                const auto vout_21p11_00 =
                                        wrapper::vmlal(vscaled0_offseted_21p11_00, wrapper::vgetlow(vin1_16p0_0),
                                                       vscale1_5p11);
                                const auto vout_21p11_01 =
                                        wrapper::vmlal(vscaled0_offseted_21p11_01, wrapper::vgethigh(vin1_16p0_0),
                                                       vscale1_5p11);
                                const auto vout_21p11_10 =
                                        wrapper::vmlal(vscaled0_offseted_21p11_10, wrapper::vgetlow(vin1_16p0_1),
                                                       vscale1_5p11);
                                const auto vout_21p11_11 =
                                        wrapper::vmlal(vscaled0_offseted_21p11_11, wrapper::vgethigh(vin1_16p0_1),
                                                       vscale1_5p11);
                            ...
                            for (; x < window_end_x; ++x) {
                                ...
                                out_ptr[x] = wrapper::vqrshrn<8>(
                                        wrapper::vqrshrn_ex<shift_amount_remainder, ScalarType>(
                                                int32_t(in0_ptr[x]) * in0_scale_5p11 +
                                                int32_t(in1_ptr[x]) * in1_scale_5p11 + offset_21p11));
#else  // __aarch64__
                                out_ptr[x] = utility::clamp<int, ScalarType>(
        ...
        void add_sub_qasymm8_neon(const BIITensor *src0,
            ...
            const auto offset =
                    float(oq_info.offset) - scale1 * float(iq1_info.offset) - scale2 * float(iq2_info.offset);
                ...
                execute_window_loop(
                        ...
                        [&](const BICoordinates &) {
                            ...
                            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                                ...
                                const auto af_0 = vmlaq_f32(bf, vcvtq_f32_u32(vmovl_u16(vget_low_u16(a_u16_0))),
                                                            vscale1);
                                const auto af_1 = vmlaq_f32(bf, vcvtq_f32_u32(vmovl_u16(vget_high_u16(a_u16_0))),
                                                            vscale1);
                                const auto af_2 = vmlaq_f32(bf, vcvtq_f32_u32(vmovl_u16(vget_low_u16(a_u16_1))),
                                                            vscale1);
                                const auto af_3 = vmlaq_f32(bf, vcvtq_f32_u32(vmovl_u16(vget_high_u16(a_u16_1))),
                                                            vscale1);
...
#ifdef __aarch64__
                                output_ptr[x] = misc::utility::clamp<int, uint8_t>(support::cpp11::lround(result));
#else  // __aarch64__
                                output_ptr[x] = misc::utility::clamp<int, uint8_t>(support::cpp11::trunc(result));
#endif // __aarch64__
                            }
                        },
                ...
                execute_window_loop(
                        ...
                        [&](const BICoordinates &) {
                            ...
                            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                                ...
                                const auto af_0 = vmlaq_f32(voffset, vcvtq_f32_u32(vmovl_u16(vget_low_u16(a_u16_0))),
                                                            vscale1);
                                const auto af_1 = vmlaq_f32(voffset, vcvtq_f32_u32(vmovl_u16(vget_high_u16(a_u16_0))),
                                                            vscale1);
                                const auto af_2 = vmlaq_f32(voffset, vcvtq_f32_u32(vmovl_u16(vget_low_u16(a_u16_1))),
                                                            vscale1);
                                const auto af_3 = vmlaq_f32(voffset, vcvtq_f32_u32(vmovl_u16(vget_high_u16(a_u16_1))),
                                                            vscale1);

                                const auto bf_0 = vmlaq_f32(af_0, vcvtq_f32_u32(vmovl_u16(vget_low_u16(b_u16_0))),
                                                            vscale2);
                                const auto bf_1 = vmlaq_f32(af_1, vcvtq_f32_u32(vmovl_u16(vget_high_u16(b_u16_0))),
                                                            vscale2);
                                const auto bf_2 = vmlaq_f32(af_2, vcvtq_f32_u32(vmovl_u16(vget_low_u16(b_u16_1))),
                                                            vscale2);
                                const auto bf_3 = vmlaq_f32(af_3, vcvtq_f32_u32(vmovl_u16(vget_high_u16(b_u16_1))),
                                                            vscale2);
                    ...
                    rf_3          = vcvtq_s32_f32(bf_3);
                            ...
                            for (; x < window_end_x; ++x) {
                                const auto result =
                                        float(input1_ptr[x]) * scale1 + float(input2_ptr[x]) * scale2 + offset;
#ifdef __aarch64__
                                output_ptr[x] = misc::utility::clamp<int, uint8_t>(support::cpp11::lround(result));
#else  // __aarch64__
                                output_ptr[x] = misc::utility::clamp<int, uint8_t>(support::cpp11::trunc(result));
                ...
                execute_window_loop(
                        ...
                        [&](const BICoordinates &) {
                            ...
                            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                                ...
                                const auto af_0 = vmlaq_f32(bf, vcvtq_f32_s32(vmovl_s16(vget_low_s16(a_s16_0))),
                                                            vscale1);
                                const auto af_1 = vmlaq_f32(bf, vcvtq_f32_s32(vmovl_s16(vget_high_s16(a_s16_0))),
                                                            vscale1);
                                const auto af_2 = vmlaq_f32(bf, vcvtq_f32_s32(vmovl_s16(vget_low_s16(a_s16_1))),
                                                            vscale1);
                                const auto af_3 = vmlaq_f32(bf, vcvtq_f32_s32(vmovl_s16(vget_high_s16(a_s16_1))),
                                                            vscale1);
                    ...
                    rf_3          = vcvtq_s32_f32(af_3);
                            ...
                            for (; x < window_end_x; ++x) {
                                const auto result = float(non_broadcast_input_ptr[x]) * af_scale + bfs;
#ifdef __aarch64__
                                output_ptr[x] = misc::utility::clamp<int, int8_t>(support::cpp11::lround(result));
#else  // __aarch64__
                ...
                execute_window_loop(
                        ...
                        [&](const BICoordinates &) {
                            ...
                            for (; x <= (window_end_x - window_step_x); x += window_step_x) {
                                ...
                                const auto af_0 = vmlaq_f32(voffset, vcvtq_f32_s32(vmovl_s16(vget_low_s16(a_s16_0))),
                                                            vscale1);
                                const auto af_1 = vmlaq_f32(voffset, vcvtq_f32_s32(vmovl_s16(vget_high_s16(a_s16_0))),
                                                            vscale1);
                                const auto af_2 = vmlaq_f32(voffset, vcvtq_f32_s32(vmovl_s16(vget_low_s16(a_s16_1))),
                                                            vscale1);
                                const auto af_3 = vmlaq_f32(voffset, vcvtq_f32_s32(vmovl_s16(vget_high_s16(a_s16_1))),
                                                            vscale1);

                                const auto bf_0 = vmlaq_f32(af_0, vcvtq_f32_s32(vmovl_s16(vget_low_s16(b_s16_0))),
                                                            vscale2);
                                const auto bf_1 = vmlaq_f32(af_1, vcvtq_f32_s32(vmovl_s16(vget_high_s16(b_s16_0))),
                                                            vscale2);
                                const auto bf_2 = vmlaq_f32(af_2, vcvtq_f32_s32(vmovl_s16(vget_low_s16(b_s16_1))),
                                                            vscale2);
                                const auto bf_3 = vmlaq_f32(af_3, vcvtq_f32_s32(vmovl_s16(vget_high_s16(b_s16_1))),
                                                            vscale2);
        ...
        template void add_sub_q8_neon_fixedpoint<int8_t>(const BIITensor *src0,
                                                         const BIITensor *src1,
                                                         BIITensor *dst,
                                                         const BIConvertPolicy &policy,
                                                         const BIWindow &window,
        ...
        template void add_sub_q8_neon_fixedpoint<uint8_t>(const BIITensor *src0,
                                                          const BIITensor *src1,
                                                          BIITensor *dst,
                                                          const BIConvertPolicy &policy,
                                                          const BIWindow &window,
