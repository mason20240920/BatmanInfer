...
namespace BatmanInfer {
    namespace cpu {
        ...
        void neon_qasymm8_softmax(const BIITensor *in,
                                  void *const tmp,
                                  BIITensor *out,
                                  const float beta,
                                  int axis,
        ...
        template void neon_qasymm8_softmax<true>(const BIITensor *in,
                                                 void *const tmp,
                                                 BIITensor *out,
                                                 const float beta,
                                                 int axis,
        ...
        template void neon_qasymm8_softmax<false>(const BIITensor *in,
                                                  void *const tmp,
                                                  BIITensor *out,
                                                  const float beta,
                                                  int axis,
