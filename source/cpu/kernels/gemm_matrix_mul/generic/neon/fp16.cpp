        ...
        namespace {
                ...
                execute_window_loop(
                        ...
                        [&](const BICoordinates &) {
                            ...
                            for (; x < window_end_x; ++x) {
                                ...
                                float16_t acc =
                                        vget_lane_f16(vacc, 0) + vget_lane_f16(vacc, 1) + vget_lane_f16(vacc, 2) +
                                        vget_lane_f16(vacc, 3);
            ...
            void matrix_matrix_multiply_f16(
                ...
                win_b.set(BIWindow::DimX,
                          BIWindow::BIDimension(window.x().start() / 8, window.x().end() / 8, in_b_stride));
                ...
                execute_window_loop(
                        ...
                        [&](const BICoordinates &id) {
                            ...
                            float16x8x4_t c = {
                                    {vdupq_n_f16(0.f), vdupq_n_f16(0.f), vdupq_n_f16(0.f), vdupq_n_f16(0.f)}};
