...
namespace graph {
    ...
    DummyNode::DummyNode(BITensorShape shape) : _shape(shape)
    {
    ...
    BITensorDescriptor DummyNode::configure_output(size_t idx) const
    {
    ...
    BINodeType DummyNode::type() const
    {
        return BINodeType::Dummy;
    }

    void DummyNode::accept(BIINodeVisitor &v)
    {
        v.visit(*this);
    }
