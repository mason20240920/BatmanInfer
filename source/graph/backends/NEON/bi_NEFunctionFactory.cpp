    ...
    std::unique_ptr<BIIFunction> BINEFunctionFactory::create(BIINode *node, BIGraphContext &ctx)
    {
        ...
        switch (type)
        {
            ...
            case BINodeType::DepthToSpaceLayer:
                return detail::create_depth_to_space_layer<NEDepthToSpaceLayer, BINETargetInfo>(
                    *polymorphic_downcast<DepthToSpaceLayerNode *>(node));
            case BINodeType::DeconvolutionLayer:
                return detail::create_deconvolution_layer<NEDeconvolutionLayer, BINETargetInfo>(
                    *polymorphic_downcast<DeconvolutionLayerNode *>(node), ctx);
            case BINodeType::ConcatenateLayer:
                return detail::create_concatenate_layer<NEConcatenateLayer, BINETargetInfo>(
                    *polymorphic_downcast<ConcatenateLayerNode *>(node));
            case BINodeType::DepthwiseConvolutionLayer:
                return detail::create_depthwise_convolution_layer<NEDepthwiseConvolutionLayer, BINETargetInfo>(
                    *polymorphic_downcast<DepthwiseConvolutionLayerNode *>(node));
            case BINodeType::DequantizationLayer:
                return detail::create_dequantization_layer<NEDequantizationLayer, BINETargetInfo>(
            ...
            case BINodeType::EltwiseLayer:
                return detail::create_eltwise_layer<NEEltwiseFunctions, BINETargetInfo>(
            ...
            case BINodeType::FlattenLayer:
                return detail::create_flatten_layer<NEFlattenLayer, BINETargetInfo>(
                    *polymorphic_downcast<FlattenLayerNode *>(node));
            case BINodeType::FullyConnectedLayer:
                return detail::create_fully_connected_layer<NEFullyConnectedLayer, BINETargetInfo>(
            ...
            case BINodeType::PermuteLayer:
                return detail::create_permute_layer<NEPermute, BINETargetInfo>(
            ...
            case BINodeType::PReluLayer:
                return detail::create_prelu_layer<NEPReluLayer, BINETargetInfo>(
            ...
            case BINodeType::QuantizationLayer:
                return detail::create_quantization_layer<NEQuantizationLayer, BINETargetInfo>(
            ...
            case BINodeType::ReshapeLayer:
                return detail::create_reshape_layer<NEReshapeLayer, BINETargetInfo>(
                    *polymorphic_downcast<ReshapeLayerNode *>(node));
            case BINodeType::ResizeLayer:
                return detail::create_resize_layer<NEScale, BINETargetInfo>(*polymorphic_downcast<ResizeLayerNode *>(node));
            case BINodeType::SliceLayer:
                return detail::create_slice_layer<NESlice, BINETargetInfo>(*polymorphic_downcast<SliceLayerNode *>(node));
            case BINodeType::SoftmaxLayer:
                return detail::create_softmax_layer<NESoftmaxLayer, BINETargetInfo>(
