...
#include "data/core/neon/kernels/arm_gemm/quantized.hpp"
...
namespace BatmanGemm {
    ...
    void row_sums_indirect(
        ...
        __asm__ __volatile__(
                ...
                : [M] "+&r"(M), [input_offset] "+&r"(input_offset), [input_ptr] "+&r"(input_ptr), [out_ptr] "+&r"(
                out_ptr)
        : [args_ptr] "r"(&ka), [b_offset] "I"(offsetof(Requantize32, b_offset)), [flags] "r"(
                flags), [offsetof_input_initial_col] "I"(
                offsetof(KernelArgs, input_initial_col)), [offsetof_num_strings] "I"(
                offsetof(KernelArgs, num_strings)), [offsetof_string_lengths] "I"(
                offsetof(KernelArgs, string_lengths)), [qp] "r"(qp)
