...
#include "data/core/neon/kernels/arm_gemm/kernels/a64_hybrid_s8qa_dot_4x16.hpp"
#include "data/core/neon/kernels/arm_gemm/kernels/a64_hybrid_s8qa_mmla_4x16.hpp"
#include "data/core/neon/kernels/arm_gemm/kernels/a64_hybrid_s8qs_dot_6x16.hpp"
#include "data/core/neon/kernels/arm_gemm/kernels/a64_hybrid_s8qs_mmla_6x16.hpp"
...
namespace BatmanGemm {
    ...
    static const GemmImplementation<int8_t, int8_t, int8_t, Requantize32> gemm_qint8_methods[] =
            {
                    ...
                    GemmImplementation<int8_t, int8_t, int8_t, Requantize32>::with_estimate(
                            ...
                            [](const GemmArgs &args, const Requantize32 &) {
                                return GemmHybridIndirect<cls_a64_hybrid_s8qa_mmla_4x16, int8_t, int8_t, int8_t, Requantize32>::estimate_cycles<int8_t>(
                                        args);
                            },
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return new GemmHybridIndirect<cls_a64_hybrid_s8qa_mmla_4x16, int8_t, int8_t, int8_t, Requantize32>(
                                        args, qp);
                            }
                    ),
                    GemmImplementation<int8_t, int8_t, int8_t, Requantize32>::with_estimate(
                            ...
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return args._ci->has_i8mm() && quant_hybrid_symmetric(qp);
                            },
                            [](const GemmArgs &args, const Requantize32 &) {
                                return GemmHybridIndirect<cls_a64_hybrid_s8qs_mmla_6x16, int8_t, int8_t, int8_t, Requantize32>::estimate_cycles<int8_t>(
                                        args);
                            },
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return new GemmHybridIndirect<cls_a64_hybrid_s8qs_mmla_6x16, int8_t, int8_t, int8_t, Requantize32>(
                                        args, qp);
                            }
                    ),
                    GemmImplementation<int8_t, int8_t, int8_t, Requantize32>::with_estimate(
                            ...
                            [](const GemmArgs &args, const Requantize32 &) {
                                return GemmInterleavedQuantized<cls_a64_interleaved_s8s32_mmla_8x12, int8_t, int8_t, int8_t>::estimate_cycles<int8_t>(
                                        args);
                            },
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return new GemmInterleavedQuantized<cls_a64_interleaved_s8s32_mmla_8x12, int8_t, int8_t, int8_t>(
                                        args, qp);
                            }
                    ),
                    GemmImplementation<int8_t, int8_t, int8_t, Requantize32>::with_estimate(
                            ...
                            [](const GemmArgs &args, const Requantize32 &) {
                                return GemmHybridIndirect<cls_a64_hybrid_s8s32_mmla_6x16, int8_t, int8_t, int8_t, Requantize32, true>::estimate_cycles<int8_t>(
                                        args);
                            },
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return new GemmHybridIndirect<cls_a64_hybrid_s8s32_mmla_6x16, int8_t, int8_t, int8_t, Requantize32, true>(
                                        args, qp);
                            }
                    ),
                    {
                            ...
                            [](const GemmArgs &args, const Requantize32 &) {
                                return !(args._ci->has_svei8mm() || args._ci->has_i8mm());
                            },
                            [](const GemmArgs &args, const Requantize32 &qp) {
                    ...
                    },
                    {
                            ...
                            [](const GemmArgs &args, const Requantize32 &) {
                                return args._ci->has_dotprod() && (args._Nsize % 4 == 0) && (args._Ksize > 32) &&
                                       (args._Ksize <= 64) && !args._indirect_input;
                            },
                            [](const GemmArgs &args, const Requantize32 &) {
                                return !(args._ci->has_svei8mm() || args._ci->has_i8mm());
                            },
                    ...
                    },
                    {
                            ...
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return new GemmInterleavedQuantized<cls_a64_gemm_s16_8x12, int8_t, int8_t, int8_t>(args,
                                                                                                                   qp);
                            }
                    },
                    GemmImplementation<int8_t, int8_t, int8_t, Requantize32>::with_estimate(
                            ...
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return args._ci->has_dotprod() && quant_hybrid_symmetric(qp);
                            },
                            [](const GemmArgs &args, const Requantize32 &) {
                                return GemmHybridIndirect<cls_a64_hybrid_s8qs_dot_6x16, int8_t, int8_t, int8_t, Requantize32>::estimate_cycles<int8_t>(
                                        args);
                            },
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return new GemmHybridIndirect<cls_a64_hybrid_s8qs_dot_6x16, int8_t, int8_t, int8_t, Requantize32>(
                                        args, qp);
                            }
                    ),
                    GemmImplementation<int8_t, int8_t, int8_t, Requantize32>::with_estimate(
                            ...
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return args._ci->has_dotprod() && quant_hybrid_asymmetric(qp);
                            },
                            [](const GemmArgs &args, const Requantize32 &) {
                                return GemmHybridIndirect<cls_a64_hybrid_s8qa_dot_4x16, int8_t, int8_t, int8_t, Requantize32>::estimate_cycles<int8_t>(
                                        args);
                            },
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return new GemmHybridIndirect<cls_a64_hybrid_s8qa_dot_4x16, int8_t, int8_t, int8_t, Requantize32>(
                                        args, qp);
                            }
                    ),
                    GemmImplementation<int8_t, int8_t, int8_t, Requantize32>::with_estimate(
                            ...
                            [](const GemmArgs &args, const Requantize32 &) {
                                return GemmHybridIndirect<cls_a64_hybrid_s8s32_dot_6x16, int8_t, int8_t, int8_t, Requantize32, true>::estimate_cycles<int8_t>(
                                        args);
                            },
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return new GemmHybridIndirect<cls_a64_hybrid_s8s32_dot_6x16, int8_t, int8_t, int8_t, Requantize32, true>(
                                        args, qp);
                            }
                    ),
                    GemmImplementation<int8_t, int8_t, int8_t, Requantize32>::with_estimate(
                            ...
                            [](const GemmArgs &args, const Requantize32 &) { return args._ci->has_dotprod(); },
                            [](const GemmArgs &args, const Requantize32 &) {
                                return GemmInterleavedQuantized<cls_a64_gemm_s8_8x12, int8_t, int8_t, int8_t>::estimate_cycles<int8_t>(
                                        args);
                            },
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return new GemmInterleavedQuantized<cls_a64_gemm_s8_8x12, int8_t, int8_t, int8_t>(args,
                                                                                                                  qp);
                            }
                    ),
                    GemmImplementation<int8_t, int8_t, int8_t, Requantize32>::with_estimate(
                            ...
                            nullptr,
                            [](const GemmArgs &args, const Requantize32 &) {
                                return GemmInterleavedQuantized<cls_a64_gemm_s8_4x4, int8_t, int8_t, int8_t>::estimate_cycles<int8_t>(
                                        args);
                            },
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return new GemmInterleavedQuantized<cls_a64_gemm_s8_4x4, int8_t, int8_t, int8_t>(args,
                                                                                                                 qp);
                            }
                    ),
                    {
                            ...
                            [](const GemmArgs &args, const Requantize32 &qp) {
                                return new QuantizeWrapper<int8_t, int8_t, int32_t>(args, qp);
                            }
                    },
                    {
                            GemmMethod::DEFAULT,
    ...
    template<>
    const GemmImplementation<int8_t, int8_t, int8_t, Requantize32> *
    gemm_implementation_list<int8_t, int8_t, int8_t, Requantize32>() {
        return gemm_qint8_methods;
    }

    template UniqueGemmCommon<int8_t, int8_t, int8_t>
    gemm<int8_t, int8_t, int8_t, Requantize32>(const GemmArgs &args, const Requantize32 &os);

    template bool has_opt_gemm<int8_t, int8_t, int8_t, Requantize32>(WeightFormat &weight_format, const GemmArgs &args,
                                                                     const Requantize32 &os);

    template KernelDescription
    get_gemm_method<int8_t, int8_t, int8_t, Requantize32>(const GemmArgs &args, const Requantize32 &os);

    template std::vector<KernelDescription>
    get_compatible_kernels<int8_t, int8_t, int8_t, Requantize32>(const GemmArgs &args, const Requantize32 &os);
